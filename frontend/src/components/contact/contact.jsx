...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      ...
      <iframe width="100%" height="100%" class="absolute inset-0 grayscale contrast-120 opacity-40" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed/v1/view?zoom=17&center=28.6100%2C77.0380&key=AIzaSyBAKQCJnVodR4p7yvt02sB6FnlhNaorJj8"></iframe>"
