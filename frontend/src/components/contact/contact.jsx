        ...
        <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <iframe
              width="100%"
              height="100%"
              class="absolute inset-0 grayscale-10 contrast-120 opacity-80 "
              frameborder="0"
              title="map"
              marginheight="0"
              marginwidth="0"
              scrolling="no"
              src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=mechanical department nsit&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
            ></iframe>
            "
            ...
            <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              <div class="lg:w-1/2 px-6">
                ...
                <p class="mt-1">
                  Mechanical Engineering Department, Netaji Subhas University of
                  Technology, Sector 3, Dwarka, Delhi 110078
                </p>
              </div>
          ...
          >
            ...
            <p class="leading-relaxed mb-5 text-gray-600">
              We get back you as soon as possible.
            </p>
