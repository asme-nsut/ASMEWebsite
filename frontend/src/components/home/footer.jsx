...
function footer() {
  ...
  return (
        ...
        <div class="container px-5 py-14 mx-auto">
          <div class="flex flex-wrap md:text-left text-center order-first">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav class="list-none mb-10">
                <li>
                  <a class="text-gray-600 hover:text-gray-800" href="/events">Competitions</a>
                </li>
                <li>
    ...
    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <img class="w-10 h-10 mt-1" src="/GalleryImages/ASME_NSUT_Logo.png" alt="asme logo"/>
        
        <span class="ml-3 text-xl">ASME</span>
      </a>
      <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4 mx-10 text-center">© 2025 ASME
        <a href="https://www.asmesut.com/" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank"></a>
      </p>
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
        <a class="text-gray-500" href="https://www.facebook.com/DevcommNsut">
          <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
            <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
          </svg>
        </a>
        
        <a class="ml-3 text-gray-500" href="https://www.instagram.com/devcomm.nsut/">
