...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">What is American Society of
        <br class="hidden lg:inline-block"/> Mechanical Engineers?
      </h1>
      <p class="mb-6 leading-relaxed">ASME yearns to see it’s student body, and students associated to it, develop in the field of mechanical engineering. ASME has always proposed and implemented the ideas of enlightening students on the practical applications of concepts taught in a classroom. ASME brings up projects and events that help the students broaden their horizons over various subjects and themes.</p>
      <p class="mb-6 leading-relaxed">The ASME student body has already brought many changes among the students and their interests pertaining to mechanical engineering and it’s relevance to our daily life.</p>
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" alt="hero" src={require('../../Assets/images/heroImage2.png')}/>
    </div>
  </div>
</section>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Why ASME?</h1>
    ...
    <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">WHO ARE WE</h2>
          <p class="leading-relaxed text-base">We are a bunch of enthusiastic engineers who aim to revolutionise this world with the proper blend of science and nature. Being in mechanical-mechatronics discipline engineering, we possess a diverse knowledge of mechanical, electronics, computer and control engineering which enables us to think beyond the books and do beyond the existing.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">SUCCESS PATH</h2>
          <p class="leading-relaxed text-base">Our success path is paved by the zeal to work hard, curiosity to learn, and determination to develop. We walk on this path united, taking technology with the people and making them aware of the boons of science. Our goal is to engineer a world where science can be efficiently used to make daily life expedient and people can live together in harmony.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-4 text-center">
      <div class="p-4 sm:w-1/4 w-1/2">
        <h2 class="title-font font-medium sm:text-4xl text-3xl text-gray-900">1880</h2>
        <p class="leading-relaxed">Year Established</p>
      </div>
      <div class="p-4 sm:w-1/4 w-1/2">
        <h2 class="title-font font-medium sm:text-4xl text-3xl text-gray-900">8500+</h2>
        <p class="leading-relaxed">Active Members</p>
      </div>
      <div class="p-4 sm:w-1/4 w-1/2">
        <h2 class="title-font font-medium sm:text-4xl text-3xl text-gray-900">135+</h2>
